...
# libc++
if(VOE_USE_CUSTOM_LIBCXX)
  message(STATUS "Using custom libc++ located at ${VOE_USE_CUSTOM_LIBCXX}")

  add_compile_options(-nostdinc++ -isystem
                      "${VOE_USE_CUSTOM_LIBCXX}/include/c++/v1")

  add_link_options(-nostdlib++ "-L${VOE_USE_CUSTOM_LIBCXX}/lib/c++"
                   -Wl,-rpath,"${VOE_USE_CUSTOM_LIBCXX}"/lib/c++ -lc++ -lc++abi)
else()
  message(STATUS "Using system libc++")

  add_compile_options(-stdlib=libc++)
  add_link_options(-stdlib=libc++)
endif(VOE_USE_CUSTOM_LIBCXX)
